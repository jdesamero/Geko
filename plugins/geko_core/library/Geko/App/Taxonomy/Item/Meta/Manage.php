<?php
/*
 * "geko_core/library/Geko/App/Taxonomy/Item/Meta/Manage.php"
...
//
class Geko_App_Taxonomy_Item_Meta_Manage extends Geko_App_Entity_Manage
{
	...
	public function start() {
		...
		$oSqlTable
			->create( '##pfx##taxonomy_item_meta', 'tim' )
			->fieldBigInt( 'id', array( 'unsgnd', 'notnull', 'autoinc', 'prky' ) )
			->fieldBigInt( 'taxonomy_item_id', array( 'unsgnd', 'notnull' ) )

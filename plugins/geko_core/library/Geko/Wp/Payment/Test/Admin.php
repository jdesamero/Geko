...
// abstract
class Geko_Wp_Payment_Test_Admin extends Geko_Wp_Payment_Admin
{
	
	protected $_sPrefix = 'geko_pay_test';
	
	protected $_sMenuTitle = 'Test Payment';
	protected $_sAdminType = 'Test Payment Gateway';

<?php
/*
 * "geko_navigation_management/includes/library/Geko/Wp/NavigationManagement/Integration/PageManager/Page.php"
...
//
class Geko_Wp_NavigationManagement_Integration_PageManager_Page

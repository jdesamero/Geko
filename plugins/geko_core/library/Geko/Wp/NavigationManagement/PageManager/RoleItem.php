<?php
/*
 * "geko_core/library/Geko/Wp/NavigationManagement/PageManager/RoleItem.php"
...
//
class Geko_Wp_NavigationManagement_PageManager_RoleItem
	extends Geko_Navigation_PageManager_ImplicitLabelAbstract
{
	...
	public function outputStyle() {
		?>	
		.type-##type## { background-color: azure; border: dotted 1px darkturquoise; }
		<?php
	}
	...
	public function outputHtml() {
		?>
		<label for="##nvpfx_type##role_id">Active on Matching Role</label>

...
// Geko_Wp_Category_Alias::getInstance()->init();
// Geko_Wp_Category_Template::getInstance()->init();
Geko_Wp_Category_PostTemplate::getInstance()->init();

Geko_Wp_Ext_StoreLocatorPlus::getInstance()->init();

// ---------------------------------------------------------------------------------------------- //

Gloc_CustomHooks::getInstance()->init();

// Gloc_User_Manage::getInstance()->init();
Gloc_Post_Meta::getInstance()->init();
Gloc_Post_Location_Manage::getInstance()->init();

Gloc_Page_Meta::getInstance()->init();

// ---------------------------------------------------------------------------------------------- //

define( 'DRIVELINE_SLIDESHOW_DELAY', 7 );

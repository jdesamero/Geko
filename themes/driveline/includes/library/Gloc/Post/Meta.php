...
class Gloc_Post_Meta extends Geko_Wp_Post_Meta
{
	...
	protected function formFields() {
		...
		<table class="fields">
			...
			<?php elseif ( $oPost && $oPost->inCategory( 'brands' ) ): ?>
				<tr>
					<th><label for="brand_logo">Brand Logo (Keep Proportion of 96x59)</label></th>
					<td><div class="image_picker">
						<?php $this->echoImagePickerItems( $aImages ); ?>
						<input type="hidden" id="brand_logo" name="brand_logo" class="imgpck_field" />
					</div></td>
				</tr>		
			<?php elseif ( $oPost && $oPost->inCategory( 'locations' ) ): ?>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><input type="text" id="fax" name="fax" /></td>
				</tr>
				<tr>
					<th><label for="website">Website</label></th>
					<td colspan="2"><input type="text" id="website" name="website" /></td>
				</tr>
				<tr>
					<th><label for="hours">Hours</label></th>
					<td colspan="2"><textarea id="hours" name="hours"></textarea></td>
				</tr>
				<tr>

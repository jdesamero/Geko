...
class Gloc_Page_Meta extends Geko_Wp_Page_Meta
{
	...
	protected function preFormFields() {
		...
		<style type="text/css">
			...
			#wp_page_meta table.fields {
				width: 100%;
			}
			
			#wp_page_meta table.fields input[type=text] {
				width: 95%;
			}

			#wp_page_meta table.fields input[type=text].short {
				width: 30%;
			}
			
			#wp_page_meta table.fields textarea {
				width: 95%;
				height: 150px;
			}
			
			#wp_page_meta table.fields textarea.short {
				width: 95%;
				height: 30px;
			}
			...
			#wp_page_meta .image_picker img {
				border: solid 2px #dfdfdf;
			}
			
			#wp_page_meta .image_picker img.ip_not_selected {
				border: solid 2px #fff;		
			}
			
			#wp_page_meta .image_picker img.ip_selected {
				border: solid 2px red;
			}
			
			#wp_page_meta .selmulti {
				height: 100px;
			}
